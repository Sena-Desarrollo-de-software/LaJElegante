...
urlpatterns = [
    ...
    path("tarifa-detail/<int:pk>/", views.detail_tarifa, name="tarifa_detail"),
    ...
    path('tarifa-trashcan/', views.trashcan_tarifa, name='tarifa_trashcan'),
    # === TEMPORADA ===
    ...
    path('temporada-trashcan/', views.trashcan_temporada, name='temporada_trashcan'),
]